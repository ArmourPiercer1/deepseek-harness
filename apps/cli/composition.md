...
flowchart LR
  ...
  plugin_dsh_base_permission_engine["permission-engine<br/>@deepseek-ai/dsh-permission-engine"]
  cfg --> plugin_dsh_base_permission_engine
...
| `permission-engine` | `@deepseek-ai/dsh-permission-engine` |
