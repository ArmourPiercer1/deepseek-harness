...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    keyDomain: 'fixed by the owner\'s key table { [Kind in ChatNodeKind]: { node: ChatNode<Kind> } }, already taken: assistant-step, command, command-input, compaction, context, manual-compaction, model-retry, steering, system-prompt, team-marker, tool-call, turn-error, turn-max-tokens, turn-process, turn-tail, unknown, user, workflow-run',
    hookContext: 'string',
    ...
    occupants: [
      ...
      'client-ui-team TeamMarker key \'team-marker\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-team TeamDock id \'team\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-team TeamView id \'team\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-team TeamSettingsSection id \'team\'',
    ],
    replaceRisk: 'none',
