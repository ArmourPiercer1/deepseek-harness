...
import type { MessageAnchor, TeamMessagePage } from '@deepseek-ai/dsh-team-projection/types'
 ...
 * by their leader session, last-wins from `team` control frames, with the
