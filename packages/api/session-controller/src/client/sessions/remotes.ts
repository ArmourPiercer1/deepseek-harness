...
/** Narrow team namespace consumed by a Client Session and its manager. */
export interface SessionTeamRemote {
  projection(
    request: TeamProjectionRequest,
    signal?: AbortSignal,
  ): Promise<RemoteResult<TeamProjectionValue>>
}
...
export interface SessionRemotes {
  ...
  readonly team: SessionTeamRemote
}
